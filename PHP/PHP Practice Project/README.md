...
CityScape is a comprehensive web-based tourism platform that helps users explore cities, discover attractions, book travel packages, and share their experiences through an interactive feedback system.<br>
Website: https://smart-city-tourism-guide.netlify.app/
---

## ✨ Key Features

- 🌆 City Exploration: Browse cities with detailed insights  
- 📍 Tourist Attractions: Discover landmarks and popular spots  
- 📦 Travel Packages: View curated travel plans  
- 💬 Community Feedback: Read user reviews and ratings  
- ✍️ Add Reviews: Share your travel experience  
